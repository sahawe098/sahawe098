...
with col1 :
    ...
    st.markdown("<h1 style='text-align: left; color: red;'> Andhika Muhamad Rizky</h1>", unsafe_allow_html=True)
...
#1a
    with soal1a:
        st.markdown("<h2 style='text-align: left; color: red;'> Soal Nomor 1.a </h2>", unsafe_allow_html=True)
        option = st.selectbox(
            "",
            nation_name
        )
 ...
 #1b
    with soal1b :
        st.markdown("<h2 style='text-align: left; color: red;'> Soal Nomor 1.b </h2>", unsafe_allow_html=True)
    ...
    #1c
    with soal1c :
        st.markdown("<h2 style='text-align: left; color: red;'> Soal Nomor 1.c </h2>", unsafe_allow_html=True)
    ...
    #1d
    with soal1d :
        st.markdown("<h2 style='text-align: left; color: red;'> Soal Nomor 1.d </h2>", unsafe_allow_html=True)
        df = pd.read_csv('produksi_minyak_mentah.csv')
        df_js = pd.read_json('kode_negara_lengkap.json')
